...
const manifestoLines = ['Sites não vendem.', 'Máquinas de conversão sim.'];
...
const features: Feature[] = [
  {
    eyebrow: 'Arquitectura de Performance',
    title: 'Core Web Vitals no verde, sempre',
    tags: ['LCP < 1.5s', 'Edge Rendering', 'Bundle Splitting', 'Imagens AVIF/WebP'],
    body: 'Cada milisegundo pesa em ranking e receita. Construímos com renderização no edge, pré-carregamento inteligente e bundles auditados linha a linha. O resultado: sites que abrem antes de o utilizador piscar e passam Core Web Vitals sem esforço em produção.',
  },
  {
    eyebrow: 'SEO Técnico Nativo',
    title: 'Preparado para Google, GEO e agentes de IA',
    tags: ['Schema.org', 'SSR/SSG', 'Sitemaps Dinâmicos', 'llms.txt e MCP'],
    body: 'Não colamos SEO no fim. Renderização no servidor, structured data validada, meta dinâmica por rota e conteúdo pronto para ser interpretado por LLMs. Ficas indexável no Google clássico e citável em ChatGPT, Perplexity e outros agentes.',
  },
  {
    eyebrow: 'Design System Escalável',
    title: 'Componentes reutilizáveis, marca coerente',
    tags: ['Tokens de Design', 'Tailwind + shadcn', 'Acessibilidade AA', 'Dark/Light Ready'],
    body: 'Entregamos um design system versionado, não um conjunto de páginas soltas. Tipografia, cor e espaçamento vivem em tokens. Cada novo template nasce em horas e a marca mantém-se consistente à medida que o produto cresce.',
  },
  {
    eyebrow: 'Integrações e Automação',
    title: 'O site fala com o teu stack',
    tags: ['CRM Nativo', 'Stripe/Paddle', 'Webhooks', 'Email + WhatsApp'],
    body: 'Cada formulário, checkout ou pedido de demo alimenta o teu CRM, dispara automações de email e notifica a equipa comercial em tempo real. Sem exportações manuais, sem leads perdidos entre departamentos.',
  },
  {
    eyebrow: 'Manutenção e Evolução',
    title: 'Não te entregamos e desaparecemos',
    tags: ['CI/CD Contínuo', 'Monitorização 24/7', 'A/B Testing', 'Roadmap Trimestral'],
    body: 'Pipelines de deploy automáticos, alertas de uptime e ciclos de iteração baseados em dados reais. Analisamos comportamento, testamos hipóteses e melhoramos taxas de conversão mês após mês — o site nunca fica estagnado.',
  },
];
...
const DesenvolvimentoWeb = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Desenvolvimento Web — Sites e Plataformas de Alta Performance | Getboost Digital"
        description="Websites, e-commerce e plataformas SaaS construídos para converter, escalar e liderar em SEO técnico e Core Web Vitals."
      ...
      <section className="relative overflow-hidden bg-[#0a0603] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-28 md:py-40">
          ...
          >
            ...
            Web Engineering · Performance · SEO · Conversão
          </motion.div>
          ...
          >
            Não fazemos <em className="not-italic text-white">brochuras online</em>. Desenhamos e
            construímos plataformas web pensadas para performance, SEO técnico e conversão — do
            primeiro pixel ao último deploy. Rápidas, indexáveis, integradas com o teu negócio.
          </motion.p>
          ...
          >
            {[
              { k: '<1.5s', v: 'LCP em produção' },
              { k: '99.99%', v: 'Uptime monitorizado' },
              { k: '100/100', v: 'SEO técnico Lighthouse' },
              { k: '+40%', v: 'Conversão média pós-rebuild' },
            ].map((s) => (
              <div key={s.k}>
      ...
      <section className="bg-black text-white py-28 md:py-40">
        <div className="max-w-6xl mx-auto px-6 md:px-12 text-center">
          ...
          >
            Pronto para <span style={{ color: ACCENT }}>reescrever</span> a tua{' '}
            <span style={{ color: ACCENT }}>presença digital</span>?
          </motion.h2>
          ...
          <ConsultantContactForm
            ...
            service={{
              ...
              accent: ACCENT,
              eyebrow: 'Briefing · Desenvolvimento Web',
              headline: 'Vamos desenhar a tua próxima plataforma.',
              subhead: 'Conta-nos o objectivo, o stack actual e onde estás a perder conversão. Devolvemos uma proposta técnica com prazos, arquitectura e investimento.',
              goalOptions: [
                'Rebuild de website institucional',
                'Lançar e-commerce ou marketplace',
                'Construir plataforma SaaS/MVP',
                'Melhorar performance e SEO técnico',
                'Ainda a explorar',
              ],
              messagePlaceholder: 'Stack actual, volume de tráfego, integrações necessárias (CRM, ERP, pagamentos)…',
            }}
          />
        </div>
      </section>
