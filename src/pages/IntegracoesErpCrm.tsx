...
const manifestoLines = ['Sistemas isolados', 'custam-te dinheiro.'];
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden bg-[#0a0603] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-28 md:py-40">
          ...
          >
            ...
            ERP · CRM · iPaaS · APIs · Sincronização em Tempo Real
          </motion.div>
          ...
          >
            Ligamos <em className="not-italic text-white">ERP, CRM, e-commerce e ferramentas
            verticais</em> com uma camada de integração central, auditável e monitorizada.
            Fim do copy-paste entre sistemas, dos dados duplicados e das leads que se perdem
            entre marketing, comercial e operações.
          </motion.p>
          ...
          >
            ...
            >
              ...
              Auditoria de integrações 7 min
            </button>
          </motion.div>
          ...
          >
            {[
              { k: '<5s', v: 'Latência entre sistemas' },
              { k: '99.9%', v: 'Entregas com retry automático' },
              { k: '30+', v: 'Conectores em produção' },
              { k: '-80%', v: 'Registos duplicados' },
            ].map((s) => (
              <div key={s.k}>
      ...
      <section className="bg-black text-white py-28 md:py-40">
        <div className="max-w-6xl mx-auto px-6 md:px-12 text-center">
          ...
          >
            Pronto para <span style={{ color: ACCENT }}>ligar</span> tudo o que a tua empresa{' '}
            <span style={{ color: ACCENT }}>usa</span>?
          </motion.h2>
          ...
          <ConsultantContactForm
            ...
            service={{
              ...
              name: 'Integrações ERP e CRM',
              accent: ACCENT,
              eyebrow: 'Briefing · Integrações ERP/CRM',
              headline: 'Vamos ligar os teus sistemas.',
              subhead: 'Conta-nos que ERP, CRM e ferramentas usas hoje e onde a informação se está a perder. Devolvemos um mapa de integrações priorizado com prazos e investimento.',
              goalOptions: [
                'Sincronizar CRM e ERP',
                'Ligar e-commerce a ERP/facturação',
                'Criar API sobre sistema legacy',
                'Portal de cliente ou fornecedor',
                'Ainda a explorar',
              ],
              messagePlaceholder: 'Sistemas actuais (ERP, CRM, facturação, e-commerce), volume de registos, principais fluxos a integrar…',
            }}
          />
        </div>
      </section>
