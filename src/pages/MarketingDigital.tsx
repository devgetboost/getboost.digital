...
const manifestoLines = ['Menos táticas soltas.', 'Mais receita previsível.'];
...
const features: Feature[] = [
  ...
  },
  {
    ...
    body: 'Instalamos tracking limpo e resistente a cookieless, unificamos dados de ads, CRM e site num único painel e mostramos, canal a canal, quem gera receita real — não vaidade de clicks.',
  },
  {
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden bg-[#0a0603] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-28 md:py-40">
          ...
          >
            ...
            Digital Marketing · Full Funnel · Data-Driven · ROI
          </motion.div>
          ...
          >
            Não somos <em className="not-italic text-white">gestores de campanhas</em>. Somos o
            departamento de marketing que a tua empresa gostava de ter — com estratégia, execução e
            responsabilidade sobre o pipeline que entregamos.
          </motion.p>
          ...
          >
            {[
              { k: '5×', v: 'ROAS médio em 6 meses' },
              { k: '−42%', v: 'CAC vs. baseline' },
              { k: '+68%', v: 'LTV com retenção' },
              { k: '30d', v: 'Do kick-off ao live' },
            ].map((s) => (
              <div key={s.k}>
      ...
      <section className="bg-black text-white py-28 md:py-40">
        <div className="max-w-6xl mx-auto px-6 md:px-12 text-center">
          ...
          >
            Vamos transformar{' '}
            <span style={{ color: ACCENT }}>marketing</span> em{' '}
            <span style={{ color: ACCENT }}>máquina de crescimento</span>?
          </motion.h2>
          ...
          <ConsultantContactForm
            ...
            service={{
              ...
              accent: ACCENT,
              eyebrow: 'Briefing · Marketing Digital',
              headline: 'Vamos desenhar a tua estratégia de marketing.',
              subhead: 'Conta-nos sobre o teu negócio, canais actuais e objectivos. Preparamos um plano trimestral com investimento, entregáveis e KPIs claros.',
              goalOptions: [
                'Aumentar leads qualificadas',
                'Reduzir CAC e melhorar ROAS',
                'Escalar receita mensal',
                'Estruturar marketing do zero',
                'Ainda a explorar',
              ],
              messagePlaceholder: 'Sector, ticket médio, budget mensal em marketing, canais actuais, ferramentas (CRM, ads, analytics)…',
            }}
          />
        </div>
      </section>
