...
const manifestoLines = ['30 dias.', 'Do zero ao MVP.'];
...
const features: Feature[] = [
  {
    eyebrow: 'Semana 1 · Discovery Sprint',
    title: 'Do problema ao blueprint',
    tags: ['Product Discovery', 'User Stories', 'Wireframes Rápidos', 'Stack Definida'],
    body: 'Arrancamos com uma sprint intensiva de descoberta: entrevistamos utilizadores-chave, mapeamos o problema real, definimos o MVP mínimo viável e desenhamos os fluxos críticos. No final da semana tens um blueprint validado com escopo fechado — nada de scope creep no meio do caminho.',
  },
  {
    eyebrow: 'Semanas 2 e 3 · Build Sprint',
    title: 'Código em produção, todos os dias',
    tags: ['React + TypeScript', 'Supabase / Postgres', 'CI/CD Automático', 'Deploy Diário'],
    body: 'Duas semanas de execução pura. Stack moderna e battle-tested (React, TypeScript, Supabase, Stripe quando aplicável). Deploy contínuo desde o dia 1 — vês o produto a crescer em ambiente real, comentas em Loom, iteramos no mesmo dia. Zero sprints eternas, zero surpresas.',
  },
  {
    eyebrow: 'Semana 4 · Launch Sprint',
    title: 'Utilizadores reais, dados reais',
    tags: ['QA & Load Test', 'Analytics + Funnels', 'Landing Page', 'Onboarding UX'],
    body: 'A última semana é sobre transformar código em negócio. QA cruzado, analytics configurado (Plausible/PostHog), landing page pronta, onboarding polido. Fazemos o launch controlado com os primeiros utilizadores e recolhemos as métricas que interessam — activação, retenção e receita.',
  },
  {
    eyebrow: 'Preço fechado, sem sustos',
    title: 'Um valor. Um prazo. Um resultado.',
    tags: ['Escopo Blindado', 'Fixed Price', 'Sem Horas Extra', 'Contrato Simples'],
    body: 'Não trabalhamos por horas nem inflamos estimativas. Preço fechado à cabeça, escopo assinado na semana 1 e milestones semanais. Se algo grande mudar, renegociamos de forma transparente. O objectivo é lançar em 30 dias, não facturar por sprints intermináveis.',
  },
  {
    eyebrow: 'Depois do MVP',
    title: 'Continuidade opcional, nunca amarrada',
    tags: ['Handover Completo', 'Docs Técnicas', 'Suporte 30 dias', 'Growth Roadmap'],
    body: 'No dia 31 recebes acesso total: repositório, base de dados, deploy pipeline, documentação e um walkthrough gravado. Podes continuar com a tua equipa interna, contratar terceiros, ou seguir connosco num plano de evolução mensal. A escolha é sempre tua.',
  },
];
...
const Mvp30Dias = () => {
  ...
  return (
    <Layout>
      <SEO
        title="MVP em 30 dias — Do zero ao produto lançado | Getboost Digital"
        description="Concebemos, construímos e lançamos o teu MVP em 30 dias com preço fechado, stack moderna e deploy diário. Escopo blindado, zero surpresas."
        canonical="/solucoes/mvp-30-dias"
      ...
      <section className="relative overflow-hidden bg-[#0a0603] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-28 md:py-40">
          ...
          >
            ...
            MVP · 30 Days · Fixed Price · Ship Fast
          </motion.div>
          ...
          >
            Não vendemos <em className="not-italic text-white">promessas</em>. Vendemos um MVP em
            produção ao 30.º dia — com utilizadores reais, analytics ligado e um roadmap claro para
            iteração. Escopo blindado, preço fechado, deploy diário.
          </motion.p>
          ...
          >
            {[
              { k: '30d', v: 'Do brief ao launch' },
              { k: '1', v: 'Preço fechado' },
              { k: '4', v: 'Sprints semanais' },
              { k: '100%', v: 'Código teu' },
            ].map((s) => (
              <div key={s.k}>
      ...
      <section className="bg-black text-white py-28 md:py-40">
        <div className="max-w-6xl mx-auto px-6 md:px-12 text-center">
          ...
          >
            Pronto para <span style={{ color: ACCENT }}>lançar</span> em{' '}
            <span style={{ color: ACCENT }}>30 dias</span>?
          </motion.h2>
          ...
          >
            <button
              ...
              onMouseLeave={(e) => (e.currentTarget.style.background = 'transparent')}
            >
              {contactOpen ? 'Fechar formulário' : 'Reservar o meu sprint'}
          ...
          <ConsultantContactForm
            ...
            service={{
              ...
              name: 'MVP em 30 dias',
              accent: ACCENT,
              eyebrow: 'Briefing · MVP em 30 dias',
              headline: 'Conta-nos a tua ideia. Nós devolvemos-te o MVP.',
              subhead: 'Descreve o problema, o utilizador-alvo e o resultado que queres ver no dia 30. Preparamos um blueprint e uma proposta com preço e prazo fechados.',
              goalOptions: [
                'Validar uma ideia com utilizadores reais',
                'Lançar SaaS/marketplace mínimo',
                'Substituir processo manual por produto',
                'App interna para a minha operação',
                'Ainda a explorar',
              ],
              messagePlaceholder: 'Problema que resolves, público-alvo, funcionalidades essenciais, integrações (Stripe, Supabase, APIs externas)…',
            }}
          />
        </div>
      </section>
